...
##Choose Random Single Introgressed Haplotype
...
outf = open(output_file1, 'w')
outf2 = open(output_file2, 'w')
...
def get_introg_der_al_count_freq(line, line2): #line: from the phased haplotypes input file (inf1), line2: from the genotypes input file (inf2)
	...
	#print (ind_hapl_l)
	introg_allele_l = []
	single_random_introg_ind_col_id = random.choice(ind_column_id_l)
	for i,e in enumerate(ind_column_id_l):
		if e == single_random_introg_ind_col_id: 
